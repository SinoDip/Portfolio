...
import { graphicList } from "../../../assets/assets"; // Importing graphicList
      ...
      {graphicList.map((project, index) => (
        ...
        >
          ...
          <motion.div
            ...
            className="w-full max-w-[300px] sm:max-w-[400px] rounded-3xl cursor-pointer" // Smaller image size
          >
            <Image
              src={project.images[0]} // Using the first image in the array to show in the thumbnail
              alt={project.title}
