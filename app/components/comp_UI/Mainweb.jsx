...
import { uxuilist } from "../../../assets/assets";
  ...
  return (
    ...
    >
      ...
      <motion.h2
        ...
        className=" flex text-5xl font-Ovo sm:mt-[90%] lg:mt-4 gap-5 items-center border-b-2  dark:border-white pb-5 border-gray-700/20"
      >
        Let's start here
        <Image
